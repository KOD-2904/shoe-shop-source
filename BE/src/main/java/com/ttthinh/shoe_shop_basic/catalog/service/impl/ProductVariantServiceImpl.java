...
import com.ttthinh.shoe_shop_basic.catalog.dto.request.VariantSizeRequest;
...
import com.ttthinh.shoe_shop_basic.catalog.mapper.ProductVariantMapper;
...
import com.ttthinh.shoe_shop_basic.media.service.image.ImageUploadQueueService;
...
public class ProductVariantServiceImpl implements ProductVariantService {
  ...
  //      String imagePath = "products/"+variant.getProduct().getName()+"/images/";
    ...
    private void applyPricing(com.ttthinh.shoe_shop_basic.catalog.dto.response.VariantSizeResponse response, VariantSize size) {
