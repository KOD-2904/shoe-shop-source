...
import com.ttthinh.shoe_shop_basic.auth.security.user.UserDetailServiceImpl;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse login(LoginRequest loginRequest, HttpServletRequest httpRequest) {
        try {
            ...
            ensureLocalProviderMetadata(userAccount);
    ...
    private void ensureLocalProviderMetadata(UserAccount user) {
        if (user.getPassword() != null && !user.getPassword().isBlank() && !user.hasProvider(AuthProvider.LOCAL)) {
